    ...
    rounded-[20px] max-w-[350px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
      ...
      <div className="flex flex-row">
        ...
        <div className="flex flex-col ml-4">
          <h4 className="font-poppins font-semibol text-[20px] leading-[32px] text-white">{name}</h4>
          <p className="font-poppins font-semibol text-[16px] leading-[24px] text-dimWhite">{title}</p>
        </div>
      </div>
    </div>
)
