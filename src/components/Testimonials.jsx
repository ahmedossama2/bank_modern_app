...
const Testimonials = () => (
  <section id="clients" className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
    <div className="absloute z-[0] w-[60%] h-[60%] -right-[50%] rounded-full blue__gradient"></div>
    ...
    md:flex-row flex-col sm:mb-16 mb-6 z-[1]">
      ...
      <div className="w-full md:mt-0 mt-6">
        <p className={`${styles.paragraph} text-left max-w-[450px]`}>Everyting you need to accept 
